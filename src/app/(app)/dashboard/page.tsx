...
import { getDashboardSummary, getProjects, getStatusBadgeVariant, getStatusLabel } from "../_components/mock-data";
import {
  ButtonLink,
  ProgressBar,
  SectionHeader,
...
export default function DashboardPage() {
  ...
  const activeProjects = getProjects()
    .filter((project) => project.status === "aktif" || project.status === "tertunda")
    .slice(0, 5);
